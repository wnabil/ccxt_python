...
class pionex(Exchange, ImplicitAPI):
    ...
    async def fetch_ohlcv(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params={}) -> List[list]:
        ...
        if limit is not None:
            request['limit'] = min(limit, 500)  # default 100, max 500
        response = await self.publicGetMarketKlines(self.extend(request, params))
    ...
    async def fetch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        # "timestamp": 1566691672311
        # }
        response2 = await self.publicGetMarketBookTickers(self.extend(request, params))
        # {
        # "data": {
        #     "tickers": [
        #     ]
    ...
    async def fetch_balance(self, params={}) -> Balances:
        ...
        """
        await self.load_markets()
        response = await self.privateGetAccountBalances(self.extend(params))
        # {
        # "data": {
        #     "balances": [
        #     {
    ...
    async def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if limit is None:
            ...
            limit = min(200, limit)
        response = await self.privateGetTradeOpenOrders(self.extend(request, params))
        # {
        #     "data": {
        #       "orders":[
        #         {
    ...
    async def fetch_order_trades(self, id: str, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        response = await self.privateGetTradeFillsByOrderId(self.extend(request, params))
        # {
        #     "data": {
        #       "fills":[
        #         {
